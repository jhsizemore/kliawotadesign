...
function renderSection(){
 ...
 if(!refs.length){host.innerHTML="<div class='od-ref-summary'>No curated real-card references for this card.</div>";return}
...
function renderModal(){
 ...
 overlay.querySelector("[data-ref-grid]").innerHTML=refs.length?refs.map(function(r){return tile(r,false)}).join(""):"<div class='gallery-empty'>This card has no reference set.</div>";
