...
roles={'foodSource':[8,31,74,108,136,137,139,141], 'manifest':[80,88,116],
 'directBlink':[5], 'castFromExile':[14,112,123], 'ownGraveyardDeparture':[37,123,125,142,220],
...
'WB':('Death / household attrition','story revision needed','Common death effects and recovery can feed Medon. Antinous’s current rescue engine contradicts the exploitative portrayal. Plan: replace that engine from its existing brief before treating WB as final; preserve the common creature supply and test sacrifice access.'),
...
deck_common={
'WU':[103,103,108,108,77,87,87,110,112,115,115,107,119,64,85,5,8,23,94,113,116],
...
result={'schema':'odyssey-common-mechanics-audit/v1','method':'Manual role classification with exact hypergeometric draw calculations. Probabilities ignore mulligans, casting colours and sequencing. Card counts are distinct IDs; deck counts include copies. No booster distribution, drafting, opponent decisions or actual games are simulated.',
 ...
 'remainingGates':['Lock booster distribution before draft claims.','Expose the canonical Manifest Fate reminder; published card records use the custom action without defining it. Audit uses existing reference notes: top two, manifest one, exile the other.','WU direct-return density and WB Antinous story mismatch require design work.','Play these lists; these calculations are not results of played games.']}
